...
const Celsius = function (config) {
  ...
  return {
    ...
    getTransactionSummary: function (pagination) {
      return httpClient.get(PATHS.TRANSACTIONS_SUMMARY, pagination)
    },

    getCoinTransactions: function (coin, pagination) {
      return httpClient.get(PATHS.COIN_TRANSACTIONS(coin), pagination)
    },
