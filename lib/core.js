...
const Celsius = function (config) {
  ...
  const CelsiusInstance = {
     ...
     */
    health: function (message, userSecret) {
      return httpClient.get(PATHS.HEALTH(message), null, userSecret)
    },
    /**
     ...
     */
    getSupportedCountries: function (timestamp = null, userSecret) {
     ...
     * Creates a new user.
     * @memberOf module:celsius-js-sdk/core
     * @function createUserKyc
     * @param user {CreateUser}  Data required for creating a user
     * @param userSecret {string} - Represents a secret value used to uniquely identify users. Can be user-token or api-key
     * @returns {CreateUserResponse}
     */
    createUserKyc: function (user, userSecret) {
      return httpClient.post(PATHS.USER, user, null, userSecret)
    },
    /**
     * Update user.
     * @memberOf module:celsius-js-sdk/core
    ...
    updateUserEmail: function (email, userSecret) {
      return httpClient.put(PATHS.USER, email, null, userSecret)
    }
  }
