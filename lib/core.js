...
const Celsius = function (config) {
  ...
  const CelsiusInstance = {
    ...
    startKycVerification: function (userId, documentType, userDocuments, userSecret) {
      return httpClient.post(PATHS.KYC_VERIFICATION(userId), { document_type: documentType }, userDocuments, userSecret)
    },
    /**
    ...
    createUserKyc: function (user, userSecret) {
      return httpClient.post(PATHS.USERS, user, null, userSecret)
    },
    /**
     * Update user.
     * @memberOf module:celsius-js-sdk/core
